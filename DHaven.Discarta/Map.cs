...
namespace DHaven.DisCarta
{
    public class Map : Panel
    {
        ...
        public static readonly DependencyProperty VisualExtentProperty = DependencyProperty.RegisterAttached("VisualExtentProperty", typeof(VisualExtent), typeof(Map), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsArrange));
        ...
        public Map()
        {
            ...
            VisualExtent = new VisualExtent
            {
                Extent = Projection.World,
                ZoomLevel = 0,
                Screen = new Size()
            };
        }
